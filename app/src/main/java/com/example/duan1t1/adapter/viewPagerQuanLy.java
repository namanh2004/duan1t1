...
//
//        createFragment(int position): Đây là phương thức trừu tượng được ghi đè từ lớp cha. Nó được sử dụng để tạo và trả về một fragment dựa trên vị trí (position) của ViewPager2. Trong phương thức này, sử dụng câu lệnh switch-case để xác định fragment nào sẽ được tạo ra dựa trên vị trí được chỉ định. Nếu vị trí là 0, phương thức trả về một fragment QuanLyKhachHang. Nếu vị trí là 1, phương thức trả về một fragment frg_lichsunap. Trong trường hợp mặc định, nếu vị trí không phù hợp với bất kỳ trường hợp nào khác, phương thức trả về một fragment QuanLyKhachHang.
//
